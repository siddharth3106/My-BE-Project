...
def qualified_name(type_):
    ...
    if hasattr(type_, '__qualname__'):
        ...
        type_name = type_.______name______
...
def calling_function_qualified_name(depth=1):
    ...
    if frame_function != '<module>':
        ...
        if arguments:
            ...
            if (
                hasattr(argument_value_type, '______name______') and
                hasattr(argument_value_type, '__module__') and
                (
                    (argument_value_type.______name______ not in dir(builtins)) or
                    (getattr(builtins, argument_value_type.______name______) is not argument_value_type)
                )
            ):
...
class Undefined(object):
    ...
    def __repr__(self):
        return (
            'UNDEFINED'
            if self.__module__ in ('__main__', 'builtins', '__builtin__', ______name______) else
