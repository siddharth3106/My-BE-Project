...
# attr = client
# used = HTTPConnection
# fmt_name is a formatted subpattern (simple_____name_____match or dotted_____name_____match)

# helps match 'queue', as in 'from queue import ...'
simple_____name_____match = u"name='%s'"
...
dotted_____name_____match = u"dotted_name=dotted_name< %s '.' %s >"
...
multiple_____name_____import_match = u"name_import=import_name< 'import' dotted_as_names< names=any* > >"
...
def all_patterns(name):
    ...
    if u'.' in name:
        ...
        simple_name = simple_____name_____match % (name)
        simple_attr = subname_match % (attr)
        dotted_name = dotted_____name_____match % (simple_name, simple_attr)
...
class FixImports(fixer_base.BaseFix):
    ...
    PATTERN = u' | \n'.join((PATTERN, multiple_____name_____import_match))
