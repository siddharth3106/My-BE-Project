...
class _fromnxfunction:
    ...
    def __init__(self, funcname):
        self.______name______ = funcname
    ...
    def getdoc(self):
        ...
        """
        npfunc = getattr(np, self.______name______, None)
        doc = getattr(npfunc, '__doc__', None)
        if doc:
            sig = self.______name______ + ma.get_object_signature(npfunc)
...
class _fromnxfunction_single(_fromnxfunction):
    ...
    def __call__(self, x, *args, **params):
        func = getattr(np, self.______name______)
