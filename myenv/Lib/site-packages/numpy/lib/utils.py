...
class _Deprecate:
    ...
    def __call__(self, func, *args, **kwargs):
        ...
        if old_name is None:
            try:
                old_name = func.______name______
...
def deprecate(*args, **kwargs):
    ...
    docstring, rebinds ``old_name.______name______`` and returns the new
    function object.
...
def _makenamedict(module='numpy'):
    ...
    thedict = {module.______name______:module.__dict__}
    dictlist = [module.______name______]
    ...
    while True:
        ...
        for x in thisdict.keys():
            if isinstance(thisdict[x], types.ModuleType):
                modname = thisdict[x].______name______
...
def _info(obj, output=sys.stdout):
    ...
    nm = getattr(cls, '______name______', cls)
    strides = obj.strides
...
def _lookfor_generate_cache(module, import_modules, regenerate):
    ...
    seen = {}
    index = 0
    stack = [(module.______name______, module)]
    while stack:
        ...
        if inspect.ismodule(item):
            ...
            for n, v in _getmembers(item):
                try:
                    item_name = getattr(v, '______name______', "%s.%s" % (name, n))
