...
class system_info:
    ...
    def set_info(self, **info):
        ...
        self.saved_results[self.__class__.______name______] = info
    ...
    def has_info(self):
        return self.__class__.______name______ in self.saved_results
    ...
    def get_info(self, notfound_action=0):
        ...
        if not self.has_info():
            flag = 1
            log.info(self.__class__.______name______ + ':')
        ...
        res = self.saved_results.get(self.__class__.______name______)
        ...
        if env_var and env_var in os.environ:
            ...
            if d == 'None':
                log.info('Disabled %s: %s',
                         self.__class__.______name______, '(%s is None)'
                         % (env_var,))
                return []
            if os.path.isfile(d):
...
class openblas_info(blas_info):
    ...
    def check_msvc_gfortran_libs(self, library_dirs, libraries):
        ...
        basename = self.__class__.______name______
...
class _pkg_config_info(system_info):
    ...
    def calc_info(self):
        ...
        if version:
            macros.append((self.__class__.______name______.split('.')[-1].upper(),
