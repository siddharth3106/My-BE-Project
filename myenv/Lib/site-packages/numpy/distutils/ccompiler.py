...
def CCompiler_customize_cmd(self, cmd, ignore=()):
    ...
    """
    log.info('customize %s using %s' % (self.__class__.______name______,
                                        cmd.__class__.______name______))
    ...
    if need_cxx:
        ...
        if hasattr(self, 'compiler') and 'cc' in self.compiler[0]:
            ...
            if not hasattr(self, 'compiler_cxx'):
                log.warn('Missing compiler_cxx fix for ' + self.__class__.______name______)
