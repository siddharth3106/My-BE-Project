    ...
    if verbose:
        for i, a in enumerate(arrays):
            ...
            try:
                ...
                r = f'[repr failed for <{type(a).______name______}>: {exc}]'
            if r.count('\n') > 3:
                r = '\n'.join(r.splitlines()[:3])
                r += '...'
    ...
    for function in methods:
        try:
            if hasattr(function, 'compat_func_name'):
                ...
                funcname = function.______name______
...
def assert_warns(warning_class, *args, **kwargs):
    ...
    **kwargs : Kwargs
    ...
    func = args[0]
    args = args[1:]
    with _assert_warns_context(warning_class, name=func.______name______):
...
def assert_no_warnings(*args, **kwargs):
    ...
    func = args[0]
    args = args[1:]
    with _assert_no_warnings_context(name=func.______name______):
        return func(*args, **kwargs)
    ...
    def _filter(self, category=Warning, message="", module=None, record=False):
        ...
        if self._entered:
            if module is None:
                ...
                module_regex = module.______name______.replace('.', r'\.') + '$'
                warnings.filterwarnings(
                    "always", category=category, message=message,
                    module=module_regex)
    ...
    def __enter__(self):
        ...
        for cat, mess, _, mod, log in self._suppressions:
            ...
            if mod is None:
                ...
                module_regex = mod.______name______.replace('.', r'\.') + '$'
                warnings.filterwarnings(
                    "always", category=cat, message=mess,
                    module=module_regex)
...
def assert_no_gc_cycles(*args, **kwargs):
    ...
    func = args[0]
    args = args[1:]
    with _assert_no_gc_cycles_context(name=func.______name______):
        func(*args, **kwargs)
