...
class NumpyDocTestFinder(doctest.DocTestFinder):
    ...
    def _from_module(self, module, object):
        ...
        if module is None:
            ...
            return module.______name______ == object.__module__
            ...
            return module.______name______ == object.__self__.__class__.__module__
...
class NumpyDoctest(npd.Doctest):
    ...
    def loadTestsFromModule(self, module):
        if not self.matches(module.______name______):
