...
def add_newdoc_for_scalar_type(obj, fixed_aliases, doc):
    ...
    canonical_____name_____doc = "" if obj == o.______name______ else ":Canonical name: `numpy.{}`\n    ".format(obj)
    ...
    {canonical_____name_____doc}{alias_doc}
    """.format(doc=doc.strip(), character_code=character_code,
               canonical_____name_____doc=canonical_____name_____doc, alias_doc=alias_doc)
