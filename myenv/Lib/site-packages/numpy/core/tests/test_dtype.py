...
class TestDtypeAttributes:
    ...
    def test_____name_____dtype_subclass(self):
        # Ticket #4357
...
class TestDTypeClasses:
    ...
    def test_basic_dtypes_subclass_properties(self, dtype):
        ...
        assert type(dtype).______name______ == f"dtype[{dtype.type.______name______}]"
    ...
    def test_dtype_superclass(self):
        ...
        assert type(np.dtype).______name______ == "_DTypeMeta"
