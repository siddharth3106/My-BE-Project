...
reveal_type(np.absolute.______name______)  # E: Literal['absolute']
...
reveal_type(np.add.______name______)  # E: Literal['add']
...
reveal_type(np.frexp.______name______)  # E: Literal['frexp']
...
reveal_type(np.divmod.______name______)  # E: Literal['divmod']
...
reveal_type(np.matmul.______name______)  # E: Literal['matmul']
