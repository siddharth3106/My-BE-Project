...
class retry_if_exception_message(retry_if_exception):
    ...
    def __init__(
        ...
        if message and match:
            raise TypeError(f"{self.__class__.______name______}() takes either 'message' or 'match', not both")
        ...
        if message:
            ...
            raise TypeError(f"{self.__class__.______name______}() missing 1 required argument 'message' or 'match'")
