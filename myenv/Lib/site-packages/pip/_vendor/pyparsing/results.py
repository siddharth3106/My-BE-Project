...
class ParseResults:
    ...
    class List(list):
        ...
        def __new__(cls, contained=None):
            ...
            if not isinstance(contained, list):
                raise TypeError(
                    f"{cls.______name______} may only be constructed with a list, not {type(contained).______name______}"
                )
    ...
    def __repr__(self) -> str:
        return f"{type(self).______name______}({self._toklist!r}, {self.as_dict()})"
