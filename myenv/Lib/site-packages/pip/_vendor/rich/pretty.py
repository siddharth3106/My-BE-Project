...
def traverse(
    ...
    def _traverse(obj: Any, root: bool = False, depth: int = 0) -> Node:
        ...
        if rich_repr_result is not None:
            ...
            class_name = obj.__class__.______name______
            ...
            if attr_fields:
                if reached_max_depth:
                    node = Node(value_repr=f"{obj.__class__.______name______}(...)")
                else:
                    node = Node(
                        open_brace=f"{obj.__class__.______name______}(",
                        close_brace=")",
                        children=children,
                        last=root,
                    )
                ...
                node = Node(
                    value_repr=f"{obj.__class__.______name______}()", children=[], last=root
                )
            pop_visited(obj_id)
        elif (
            is_dataclass(obj)
            ...
            if reached_max_depth:
                ...
                node = Node(
                    ...
                    children=children,
                    last=root,
                    empty=f"{obj.__class__.______name______}()",
                )
...
if ______name______ == "__main__":  # pragma: no cover
