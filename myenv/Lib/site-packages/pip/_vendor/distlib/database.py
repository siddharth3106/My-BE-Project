...
from .util import (parse_requirement, cached_property, parse_____name_____and_version,
    ...
    def provides_distribution(self, name, version=None):
        ...
        for dist in self.get_distributions():
            ...
            if not hasattr(dist, 'provides'):
                ...
                for p in provided:
                    p_name, p_ver = parse_____name_____and_version(p)
                    if matcher is None:
                        if p_name == name:
                            yield dist
                            break
...
class EggInfoDistribution(BaseInstalledDistribution):
    ...
    def __init__(self, path, env=None):
        ...
        def set_____name_____and_version(s, n, v):
            s.name = n
        ...
        if env and env._cache_enabled and path in env._cache_egg.path:
            ...
            set_____name_____and_version(self, metadata.name, metadata.version)
        else:
...
def make_graph(dists, scheme='default'):
    ...
    for dist in dists:
        ...
        for p in dist.provides:
            name, version = parse_____name_____and_version(p)
