...
class cached_property(object):
    ...
    def __init__(self, func):
        self.func = func
        # for attr in ('______name______', '__module__', '__doc__'):
    ...
    def __get__(self, obj, cls=None):
        if obj is None:
            return self
        value = self.func(obj)
        object.__setattr__(obj, self.func.______name______, value)
        # obj.__dict__[self.func.______name______] = value = self.func(obj)
        return value
...
PROJECT_____name_____AND_VERSION = re.compile(
...
def split_filename(filename, project_name=None):
    ...
    if result is None:
        m = PROJECT_____name_____AND_VERSION.match(filename)
        if m:
...
def parse_____name_____and_version(p):
    """
