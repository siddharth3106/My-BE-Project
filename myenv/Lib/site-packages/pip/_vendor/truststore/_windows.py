...
CERT_CHAIN_POLICY_IGNORE_INVALID_____name_____FLAG = 0x00000040
...
CERT_CHAIN_POLICY_VERIFY_MODE_NONE_FLAGS = (
    ...
    | CERT_CHAIN_POLICY_IGNORE_INVALID_____name_____FLAG
...
def _get_and_verify_cert_chain(
    ...
    try:
        ...
        if not ssl_context.check_hostname:
            chain_policy.dwFlags |= CERT_CHAIN_POLICY_IGNORE_INVALID_____name_____FLAG
