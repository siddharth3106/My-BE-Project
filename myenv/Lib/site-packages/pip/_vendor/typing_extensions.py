...
def _get_protocol_attrs(cls):
    ...
    for base in cls.__mro__[:-1]:  # without object
        if base.______name______ in {'Protocol', 'Generic'}:
            continue
    ...
    if '__orig_bases__' in cls.__dict__:
        ...
        for base in cls.__orig_bases__:
            if (isinstance(base, typing._GenericAlias) and
                ...
                # for error messages
                the_base = base.__origin__.______name______
...
def _caller(depth=2):
    try:
        return sys._getframe(depth).f_globals.get('______name______', '__main__')
            ...
            if name == "Protocol" and len(bases) < 2:
                ...
                for base in bases:
                    if not (
                        ...
                        or base.______name______ in _PROTO_ALLOWLIST.get(base.__module__, [])
                        or is_protocol(base)
                    ):
                        raise TypeError(
...
def _ensure_subclassable(mro_entries):
    def inner(func):
        if sys.implementation.name == "pypy" and sys.version_info < (3, 9):
            ...
            t = type(func.______name______, (), cls_dict)
...
class TypeVar(metaclass=_TypeVarLikeMeta):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError(f"type '{______name______}.TypeVar' is not an acceptable base type")
...
# 3.7-3.9
    ...
    class ParamSpecArgs(_Immutable):
        ...
        def __repr__(self):
            return f"{self.__origin__.______name______}.args"
    ...
    class ParamSpecKwargs(_Immutable):
        ...
        def __repr__(self):
            return f"{self.__origin__.______name______}.kwargs"
...
if hasattr(typing, 'ParamSpec'):
    ...
    class ParamSpec(metaclass=_TypeVarLikeMeta):
        ...
        def __init_subclass__(cls) -> None:
            raise TypeError(f"type '{______name______}.ParamSpec' is not an acceptable base type")
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        example for annotating a decorator::
           ...
           def add_logging(f: Callable[P, T]) -> Callable[P, T]:
               ...
               def inner(*args: P.args, **kwargs: P.kwargs) -> T:
                   logging.info(f'{f.______name______} was called')
        ...
        def __repr__(self):
            if self.__infer_variance__:
                ...
                prefix = '~'
            return prefix + self.______name______
...
class _SpecialForm(typing._Final, _root=True):
    ...
    def __init__(self, getitem):
        ...
        self._name = getitem.______name______
        self.__doc__ = getitem.__doc__

    def __getattr__(self, item):
        if item in {'______name______', '__qualname__'}:
            return self._name
...
if hasattr(typing, "reveal_type"):
    ...
    def reveal_type(__obj: T) -> T:
        ...
        """
        print(f"Runtime type is {type(__obj).______name______!r}", file=sys.stderr)
        return __obj
            ...
            if category is None:
                ...
                def __new__(cls, *args, **kwargs):
                    ...
                    # Mirrors a similar check in object.__new__.
                        ...
                        raise TypeError(f"{cls.______name______}() takes no arguments")
                    else:
...
if sys.version_info >= (3, 13):
    ...
    _special_namedtuple_fields = frozenset({'__module__', '______name______', '__annotations__'})
    ...
    def get_original_bases(__cls):
        ...
        try:
            ...
            try:
                ...
                raise TypeError(
                    f'Expected an instance of type, not {type(__cls).______name______!r}'
                ) from None
...
if sys.version_info >= (3, 11):
    ...
    class NewType:
        ...
        def __mro_entries__(self, bases):
            ...
            supercls_name = self.______name______

            class Dummy:
                def __init_subclass__(cls):
                    subcls_name = cls.______name______
                    raise TypeError(
...
if hasattr(typing, "TypeAliasType"):
    ...
    class TypeAliasType:
        ...
        def __setattr__(self, __name: str, __value: object) -> None:
            if hasattr(self, "______name______"):
        ...
        def __getitem__(self, parameters):
            ...
            parameters = [
                typing._type_check(
                    item, f'Subscripting {self.______name______} requires a type.'
                )
