...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.______name______}({str(self._link)!r})"
...
class AlreadyInstalledCandidate(Candidate):
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.______name______}({self.dist!r})"
...
class ExtrasCandidate(Candidate):
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.______name______}(base={self.base!r}, extras={self.extras!r})"
