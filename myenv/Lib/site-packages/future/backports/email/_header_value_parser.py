...
class TokenList(list):
    ...
    def __repr__(self):
        return '{}({})'.format(self.__class__.______name______,
...
class Terminal(str):
    ...
    def __repr__(self):
        return "{}({})".format(self.__class__.______name______, super(Terminal, self).__repr__())
...
def get_____name_____addr(value):
...
def get_mailbox(value):
    ...
    mailbox = Mailbox()
    try:
        token, value = get_____name_____addr(value)
    except errors.HeaderParseError:
        try:
            token, value = get_addr_spec(value)
        except errors.HeaderParseError:
