...
class _PolicyBase(object):
            ...
            if hasattr(self, name):
                ...
                raise TypeError(
                    "{!r} is an invalid keyword argument for {}".format(
                        name, self.__class__.______name______))

    def __repr__(self):
        args = [ "{}={!r}".format(name, value)
                 for name, value in self.__dict__.items() ]
        return "{}({})".format(self.__class__.______name______, ', '.join(args))
    ...
    def clone(self, **kw):
        ...
        for attr, value in kw.items():
            if not hasattr(self, attr):
                raise TypeError(
                    "{!r} is an invalid keyword argument for {}".format(
                        attr, self.__class__.______name______))
            object.__setattr__(newpolicy, attr, value)
        return newpolicy
    ...
    def __setattr__(self, name, value):
        ...
        raise AttributeError(msg.format(self.__class__.______name______, name))
