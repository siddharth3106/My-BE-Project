...
def requires(resource, msg=None):
    ...
    if sys._getframe(1).f_globals.get("______name______") == "__main__":
        return
...
def _filterwarnings(filters, quiet=False):
    ...
    for msg, cat in filters:
        ...
        if not seen and not quiet:
            ...
            missing.append((msg, cat.______name______))
    if reraise:
    ...
    def __init__(self, *module_names):
        ...
        for module_name in module_names:
            if module_name in sys.modules:
                ...
                # the import cache.
                if module.______name______ != module_name:
                    del sys.modules[module.______name______]
...
def run_with_locale(catstr, *locales):
    def decorator(func):
        ...
        inner.______name______ = func.______name______
