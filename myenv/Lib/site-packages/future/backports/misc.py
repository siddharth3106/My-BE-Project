...
def recursive_repr(fillvalue='...'):
    ...
    def decorating_function(user_function):
        ...
        wrapper.______name______ = getattr(user_function, '______name______')
...
class OrderedDict(dict):
    ...
    def __repr__(self):
        'od.__repr__() <==> repr(od)'
        if not self:
            return '%s()' % (self.__class__.______name______,)
        return '%s(%r)' % (self.__class__.______name______, list(self.items()))
...
class Counter(dict):
    ...
    def __repr__(self):
        ...
        try:
            ...
            return '%s({%s})' % (self.__class__.______name______, items)
        except TypeError:
            # handle case where values are not orderable
            return '{0}({1!r})'.format(self.__class__.______name______, dict(self))
...
class ChainMap(MutableMapping):
    ...
    @recursive_repr()
    def __repr__(self):
        return '{0.__class__.______name______}({1})'.format(
